      ...
      >
        <div v-if="countryOptions.length > 0" class="mt-4 text-center space-y-3">
          ...
          <div class="flex justify-center space-x-2 flex-wrap gap-2">
            <UButton size="xs" color="blue" variant="soft" @click="$emit('test-select', 'US')">
              Test: Select USA
            </UButton>
            <UButton size="xs" color="green" variant="soft" @click="$emit('test-select', 'FR')">
              Test: Select France
            </UButton>
            <UButton
              size="xs"
...
interface Emits {
  (e: 'country-selected' | 'test-select', country: string): void
